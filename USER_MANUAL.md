...
```
http://[サーバーIP]:8080/attendance.html?uuid=[イベントUUID]&server=[サーバーIP]:12345
```
...
- ✅ ファイアウォールがポート 8080、12345 をブロックしていないか確認
- ✅ デスクトップアプリが起動しているか確認
...
- **8080**: HTTP サーバー（出席登録ページ）
- **12345**: Socket.IO サーバー（リアルタイム通信）
